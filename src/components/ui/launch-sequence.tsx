    ...
    <AnimatePresence>
      {!complete && (
        ...
        >
          ...
          {/* Terminal Box */}
          <div className="relative z-20 w-[90%] max-w-2xl bg-black/80 border border-primary-400/30 p-8 font-mono shadow-[0_0_50px_rgba(129,140,248,0.15)] rounded-sm">
            <div className="flex flex-col gap-2 mb-8">
              {lines.map((line, i) => (
                <motion.div
                  ...
                  className="text-primary-400 text-sm md:text-base tracking-widest uppercase"
                >
              ...
              {!accessGranted && (
                <motion.div
                  ...
                  className="w-3 h-5 bg-primary-400 inline-block mt-1"
                />
              )}
            </div>
            ...
            <AnimatePresence>
              {accessGranted && (
                <motion.div
                  ...
                  className="text-center mt-12 py-8 border-t border-primary-400/30 relative"
                >
                  <motion.div 
                    animate={{ opacity: [0.5, 1, 0.5] }} 
                    transition={{ repeat: Infinity, duration: 2 }}
                    className="absolute inset-0 bg-primary-400/5 blur-xl"
                  />
